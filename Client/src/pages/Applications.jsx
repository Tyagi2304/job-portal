        ...
        <div className="flex gap-2 mb-6 mt-3">
          {isEdit ? (
            ...
            <div className="flex gap-2">
              <a
                className="bg-blue-100 active:bg-blue-50 text-blue-700 px-4 py-2 rounded"
                href=""
              >
                Resume
              </a>
              <button
                ...
                className="text-gray-600 border cursor-pointer active:bg-gray-100 border-gray-300 px-4 py-2 rounded"
              >
                Edit
              </button>
            </div>
            ...
            {jobsApplied.map((job, index) =>
              true ? (
                <tr>
                  ...
                  <td className="py-2 px-4 border-b border-gray-300  max-sm:hideen">
                    {job.location}
                  </td>
                  <td className="py-2 px-4 border-b border-gray-300 max-sm:hideen">
